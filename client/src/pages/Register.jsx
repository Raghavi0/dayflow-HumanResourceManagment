...
export default function Register() {
  ...
  const submit = async e => { e.preventDefault(); const r = await fetch('http://localhost:5000/api/auth/register', {method:'POST', headers:{'Content-Type':'application/json'}, body:JSON.stringify(form)}); const d = await r.json(); alert(d.message || 'Registered'); };
